...
class _ProductDetailScreenState extends State<ProductDetailScreen> {
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      context.read<ProductProvider>().getProductById(widget.productId, false);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(context.watch<ProductProvider>().selectedProduct!.name),
        centerTitle: true,
        automaticallyImplyLeading: false,
        leading: IconButton(
          icon: Icon(Icons.arrow_back_ios),
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  if (context.watch<ProductProvider>().isEditingProductName ==
                      true)
                    IconButton(
                        onPressed: () {
                          context
                      ...
                      onPressed: () {
                        if (context
                          ...
                          if (context
                            ...
                            context
                                .read<ProductProvider>()
                                .setEditProductNameErrorMessage(
                                    'Please enter supplier name');
                          } else {
                            context.read<ProductProvider>().updateNameProduct(
                                context
                                    .read<ProductProvider>()
                                    .editProductNameController
                                    .text);
                            context
                                .read<ProductProvider>()
                                .getProductById(widget.productId, false);
                            context
                                .read<ProductProvider>()
                                .toggleIsEditingProductName();
                          }
                  ...
                  child: Column(
                    children: [
                      ...
                      Container(
                        ...
                        child: DropdownButton<String>(
                          ...
                          onChanged: (String? newValue) {
                            print(newValue);
                            context.read<ProductProvider>().setAddIndexSupplier(
                                context
                      ...
                      TextFormField(
                        ...
                        controller:
                            context.watch<ProductProvider>().addPriceController,
                        keyboardType:
                    ...
                    ElevatedButton(
                        onPressed: () {
                          if (context
                            ...
                            context
                                .read<ProductProvider>()
                                .setAddPriceErrorMessage('Please enter price');
                          } else if (context
                              .read<ProductProvider>()
                              .addPriceDateTimeController
                              .text
                            ...
                            context
                                .read<ProductProvider>()
                                .setAddPriceErrorMessage('Please enter date');
                          } else {
              ...
              if (context
                ...
                Column(
                    children: List.generate(
                        context.watch<ProductProvider>().allSuppliers.length,
                        (index) {
                  return Column(
                    children: [
                      Text(context
                        ...
                        children: List.generate(
                          ...
                          return ListTile(
                            title: Text(context
                                ...
                                .toString()),
                            subtitle: Text(
                                DateHelper.getFormattedDateWithOrdinal(context
                                    .watch<ProductProvider>()
                                    .selectedProduct!
                                    .prices
                                    .where((element) =>
